...
class Agent:
    def __init__(self, model):
        ...
        self.optimizer = tensorflow.keras.optimizers.Nadam(0.0004)
    ...
    def train(self, env, resume=True):
        if resume:
            try:
                ...
                print(e)
        writer = tf.compat.v1.summary.FileWriter(TENSORBOARD_LOG) # tf.summary.FileWriter(TENSORBOARD_LOG)#create_file_writer(TENSORBOARD_LOG) tf2 /tf1
        obs = env.reset()
